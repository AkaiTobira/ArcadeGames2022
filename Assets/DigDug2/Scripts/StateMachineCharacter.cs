...
#region "Inputs && Physics"
    private void UpdatePhysics_Internal(){
        UpdateTransitions_Internal();
        UpdatePhysic();
    }

    private void UpdateTransitions_Internal(){
        T current = ActiveState;
        ActiveState = UpdateTransitions();
    ...
    */    
    ...
    protected abstract T UpdateTransitions();
    /*
